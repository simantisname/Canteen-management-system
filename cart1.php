...
if(isset($_GET["action"]))
{
  if($_GET["action"] == "update")
  {
    foreach($_SESSION["shopping_cart"] as $keys => $values)
    {
      if($values["item_id"] == $_GET["id"])
      {
        echo '<script>alert("Update Elemets")</script>';
        echo '<script>window.location="updatecart.php"</script>';
      }
    }
  }
}
      ...
      <div class="table-responsive">
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td><a href="cart1.php?action=update&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Edit</span></a></td>
          </tr>
          <?php
          ...
          <tr>
            ...
            <td><a href="cart1.php?action=confirm&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Confirm</span></a></td>
